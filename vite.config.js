...
export default defineConfig({
  ...
  define: {
    ...
    "process.env.VITE_REACT_APP_FIREBASE_AUTH_DOMAIN": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_AUTH_DOMAIN
    ),
    "process.env.VITE_REACT_APP_FIREBASE_DATABASE_URL": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_DATABASE_URL
    ),
    "process.env.VITE_REACT_APP_FIREBASE_PROJECT_ID": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_PROJECT_ID
    ),
    "process.env.VITE_REACT_APP_FIREBASE_STORAGE_BUCKET": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_STORAGE_BUCKET
    ),
    "process.env.VITE_REACT_APP_FIREBASE_MESSAGING_SENDER_ID": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_MESSAGING_SENDER_ID
    ),
    "process.env.VITE_REACT_APP_FIREBASE_APP_ID": JSON.stringify(
      process.env.VITE_REACT_APP_FIREBASE_APP_ID
    ),
    "process.env.VITE_REACT_APP_FIREBASE_MEASUREMENT_ID": JSON.stringify(
